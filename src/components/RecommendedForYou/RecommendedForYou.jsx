...
const mapProduct = item => {
  ...
  const imagesPrimary = toArray(item?.images);
...
const RecommendedForYou = ({ productId, type = 'similar', headingIcon }) => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const res = await getSimilar({ productId, type });
    ...
    () => (
      <View style={styles.headingContainer}>
        ...
        <Text style={styles.headingText}>
          <Text style={styles.orange}>Recommended </Text>
          <Text style={styles.blue}> For You</Text>
        </Text>
      </View>
    ),
    [headingIcon],
